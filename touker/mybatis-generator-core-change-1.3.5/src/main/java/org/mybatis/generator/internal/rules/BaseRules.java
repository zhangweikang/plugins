...
public abstract class BaseRules implements Rules {
    ...
    /* (non-Javadoc)
     * @see org.mybatis.generator.internal.rules.Rules#generateQueryParam()
     */
    public boolean generateQueryParam() {
        if (isModelOnly) {
            return false;
        }

        return generateFindSelective();
    }

    /* (non-Javadoc)
     * @see org.mybatis.generator.internal.rules.Rules#generateFindSelective()
     */
    public boolean generateFindSelective() {
        if (isModelOnly) {
            return false;
        }
