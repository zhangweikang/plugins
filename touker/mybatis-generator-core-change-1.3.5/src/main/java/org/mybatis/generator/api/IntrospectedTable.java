...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setQueryParamId("queryParam"); //$NON-NLS-1$
        setFindSelectiveId("find"); //$NON-NLS-1$
    }
    ...
    public void setQueryParamId(String queryParamId) {
        internalAttributes.put(InternalAttribute.ATTR_QUERY_PARAM_ID,queryParamId);
    }
    ...
    public String getQueryParamId() {
        return internalAttributes.get(InternalAttribute.ATTR_QUERY_PARAM_ID);
    }

    public void setFindSelectiveId(String findSelectiveId) {
        internalAttributes.put(InternalAttribute.ATTR_FIND_SELECTIVE_ID,findSelectiveId);
    }
    public String getFindSelectiveId() {
       return internalAttributes.get(InternalAttribute.ATTR_FIND_SELECTIVE_ID);
    }
    ...
    protected enum InternalAttribute {
        ...
        /**
         * The attr query param id.
         */
        ATTR_QUERY_PARAM_ID,

        /**
         * The attr find selective id
         */
        ATTR_FIND_SELECTIVE_ID
    }
}
