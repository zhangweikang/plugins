...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addQueryParamElement(answer);
        addFindSelectiveElement(answer);*/
        addResultMapWithoutBLOBsElement(answer);
        addBaseColumnListElement(answer);
        addQueryParamElement(answer);
        addSelectByPrimaryKeyElement(answer);
    ...
    protected void addQueryParamElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateQueryParam()) {
            AbstractXmlElementGenerator elementGenerator = new QueryParamElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }

    protected void addFindSelectiveElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateFindSelective()) {
            AbstractXmlElementGenerator elementGenerator = new FindSelectiveElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
